...
def main():
    ...
    # --- render setup -------------------------------------------------------------
    postfx.configure_cycles(scene, samples=args.samples, adaptive_threshold=args.adaptive_threshold, time_limit=args.time_limit, threads=args.threads, device=args.device, tile_size=args.tile_size, denoise=not args.no_denoise)
